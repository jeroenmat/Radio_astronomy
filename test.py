...
class test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.frequency = frequency = 1.42e9
        ...
        self.osmosdr_source_0 = osmosdr.source(
            args="numchan=" + str(1) + " " + "hackrf,bias=1"
        )
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/Users/jeroenmatthijssen/Downloads/MSc Astronomy/Courses/Radio Astronomy/test_data', False)
        ...
        self.connect((self.osmosdr_source_0, 0), (self.blocks_throttle2_0, 0))
